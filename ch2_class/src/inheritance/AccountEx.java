...
public class AccountEx {
    public static void main(String[] args) {
        ...
        try {
            // System.out.println(+checkingAccount.pay("체크카드 지불 후 잔액 : " + "111-22",
            // 300000));
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        // 교통카드
        CheckingTrafficCardAccount cardAccount = new CheckingTrafficCardAccount("111", "홍길동 ", 1000000, "222", false);
        CheckingTrafficCardAccount cardAccount1 = new CheckingTrafficCardAccount("333", "성춘향 ", 1000000, "333", true);
        ...
        try {
            ...
            System.out.println("교통비 지급 후 잔액 : " + cardAccount1.payTrafficCard("333", 210000));
        } catch (Exception e) {
            e.printStackTrace();
        }
        // 교통카드
